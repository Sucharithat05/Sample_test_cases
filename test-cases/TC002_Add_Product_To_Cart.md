...
| 4 | Click the Add to Cart button. | Success confirmation is shown indicating the product was added. |
...
## Notes
Locators are **not** part of this test case. The UI Explorer Agent discovers them at runtime and writes them to [`output/ui_explorer_TC002.json`](../output/ui_explorer_TC002.json).
